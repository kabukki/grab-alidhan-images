...
all = {
    ...
    'arme': [
        ...
        {'name': 'armemort'},
        {'name': 'armure', 'iter': 16},
        {'name': 'badgeduconscrit', 'iter': ['rvk5', 'cph4']},
        {'name': 'bague', 'iter': 9, 'pad': True},
        {'name': 'bague', 'iter': 17},
        {'name': 'bague_bete', 'iter': ['puissante', 'sup'], 'underscore': True},
        {'name': 'bague_immortel'},
        ...
        {'name': 'bas2_l'},
        {'name': 'bas8_l'},
        {'name': 'bas_tempete', 'iter': ['sup', 'scinti'], 'underscore': True},
        {'name': 'baton', 'iter': 30},
        ...
        {'name': 'botte_justice', 'iter': ['leg', 'sup'], 'underscore': True},
        ...
        {'name': 'capuche_chasseur', 'iter': ['puissant', 'sup'], 'underscore': True},
        {'name': 'capucheti9'},
        {'name': 'capuche', 'iter': 1, 'pad': True},
        {'name': 'cas_consc'},
        {'name': 'cape', 'iter': 28},
        {'name': 'casque', 'iter': 28},
        ...
        {'name': 'chapka', 'iter': 10},
        {'name': 'chaussons_volcano', 'iter': ['sup', 'scintillant'], 'underscore': True},
        {'name': 'chaussure_chasseur', 'iter': ['sup', 'puissant'], 'underscore': True},
        ...
        {'name': 'collier_infini', 'iter': ['sup', 'scintillant'], 'underscore': True},
        {'name': 'colliermort'},
        {'name': 'collier_zephyr'},
        {'name': 'cor'},
        ...
        {'name': 'eclipse'},
        {'name': 'epee', 'iter': 22},
        {'name': 'epee_justice', 'iter': ['sup', 'scin'], 'underscore': True},
        {'name': 'equip', 'iter': 61},
        {'name': 'escarpins01id3'},
        {'name': 'fleau', 'iter': 1},
        {'name': 'fronde', 'iter': 1, 'pad': True},
        {'name': 'gant_noel', 'iter': ['', '2']},
        ...
        {'name': 'grimoiremort'},
        {'name': 'hache', 'iter': 11},
        {'name': 'hache_sauvage', 'iter': ['pui', 'sup'], 'underscore': True},
        {'name': 'hachette'},
        {'name': 'haut', 'iter': 30},
        {'name': 'haut8_l'},
        {'name': 'haut14_l'},
        ...
        {'name': 'masque_nature', 'iter': ['sup', 'scintillant'], 'underscore': True},
        {'name': 'masse', 'iter': 8},
        # la faute est volontaire
        {'name': 'mitain', 'iter': 10},
        {'name': 'ombrelle01tq1'},
        {'name': 'paire_pantoufle', 'iter': ['sup', 'puissante'], 'underscore': True},
        {'name': 'pdtfnv1c2vk5'},
        {'name': 'pelle', 'iter': 1},
        ...
        {'name': 'tetine'},
        {'name': 'tiare01qr5'},
        {'name': 'toge_pelerin', 'iter': ['puissant', 'sup'], 'underscore': True},
